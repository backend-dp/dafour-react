  ...
  render(){
    ...
    <div>
        ...
        <section className="slideshow w-100 d-inline-block m-0 p-0">
            <div className="row m-0 p-0"><img className="d-block img-fluid w-100 position-absolute" src="images/bg.jpg" alt="alt" />
                    ...
                    <div className="container m-auto align-items-center text-center">
                        <div className="col-md-12 text-center align-items-center">
                            <ul className="list-inline text-center align-self-center align-items-center plan-list list-items">
                                <li className="list-inline-item m-0 p-3 list-items-active font-weight-bold" id="planType">
                                    Student Sign Up
                                </li>
                                <li className="list-inline-item m-0 p-3 font-weight-bold" id="accSetting">Professional Sign
                                    Up
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="row m-0 planType">
                            <form className="row m-0">
                                ...
                                <div className="file-field col-12">
                                    <div className="mb-4 mx-auto profile-img-container rounded-circle">
                                        <img id="profileImg"
                                             src="images/profile-pic.png"
                                             className="rounded-circle z-depth-1-half avatar-pic"
                                             alt="example placeholder avatar"/>
                                        <div className="clearfix h-100 rounded-circle position-relative"><span>Edit</span>
                                        </div>
                                    </div>
