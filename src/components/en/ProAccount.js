...
class ProAccount extends Component {
  ...
  <div className="backimg w-100 d-inline-block mt-5" id="about">
    <section className="about w90 mt-5">
      <div className="row m-0">
        <h1 className="text-center p-4 w-100">My Account</h1>
        <div className="container m-auto align-items-center text-center">
          <div className="col-md-12 text-center align-items-center">
            <ul className="list-inline text-center align-self-center align-items-center plan-list list-items">
              <li className="list-inline-item m-0 p-3 list-items-active font-weight-bold" id="planType">Plan Type</li>
              <li className="list-inline-item m-0 p-3 font-weight-bold" id="Mydocs">My Documents</li>
              <li className="list-inline-item m-0 p-3 font-weight-bold" id="accSetting">Account Setting</li>
            </ul>
          </div>
        </div>
        <div className="w-100" id="planTabs">
          <div className="container text-left mt-4 planType">
            <div className="row h-100 w-100 m-0 paper">
          ...
          <div className="col-md-4 text-left mt-4">
            <div className="row h-100 m-0 paper">
              ...
              <div className="col-12 align-self-end mt-4 p-0"> <a className="btn  btn-block text-center align-items-end align-self-end p-2" href="#test">Edit </a> </div>
            </div>
          </div>
          <div className="col-md-4 text-left mt-4">
            <div className="row h-100 m-0 paper">
            ...
            <div className="row h-100 m-0 paper">
              <div className="row m-0">
               <form className="row m-0">
                <label className="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Name</label>
                ...
                <label className="w-100 px-3 py-0 mx-0 mt-3 text-left">Degree</label>
                <div className="col-12 mt-1">
                  <input className="input-group p-3" type="text" placeholder="Degree" />
                </div>
                <label className="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Email</label>
                <div className="col-12 mt-1">
                  <input className="input-group p-3" type="email" placeholder="You Email" />
                </div>
                <label className="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Password</label>
                <div className="col-12 mt-1">
                ...
                <label className="w-100 px-3 py-0 mx-0 mt-3 text-left">Phone Number</label>
                <div className="col-12 mt-1">
                  <input className="input-group p-3" type="tel" placeholder="Your Phone Number" />
                </div>
                <label className="w-100 px-3 py-0 mx-0 mt-3 text-left">Your Country</label>
                <div className="col-12 mt-1">
                  <select className="input-group p-3">
                    <option defaultValue="selected" >Choose Country</option>
              ...
              <div className="col-12 my-3 w-100 text-center">
                <button className="btn-login py-2 px-5 font-weight-bold">Update</button>
              </div>
            </div>
          </div>
        </div>
