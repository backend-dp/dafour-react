...
class ar-forget-password extends Component {
  ...
  <section class="slideshow w-100 d-inline-block m-0 p-0">
    <div class="row m-0 p-0"> <img class="d-block img-fluid w-100 position-absolute" src="images/bg.jpg">
      <div class="search py-5 px-4">
        <p class="lead text-center">اعد ضبط كلمه السر.</p>
        <div class="row m-0">
        ...
        <div class="col-12 mt-3">
          <p class="text-left d-inline float-right"> لديك حساب؟<a href="register.html"><small>تسجيل الدخول</small></a></p>
          <div class="clearfix"></div>
        </div>
        <div class="col-12 mt-3">
...
export default ar-forget-password;